...
gcc -c "%NET%_MDF.c" -o "%NET%_MDF.obj"
g++ -o "%NET%_derive_SMC.exe" "%NET%_MDF.obj" "%BIN_DIR%\libderive_SMC_win.a" -lstdc++ -L"%BIN_DIR%" -lsolve_Factors_win -lparse_definition_win -lrand_procs_win -lmem_win -L"%SHARED_BIN_DIR%" -lsysdep_win -larbPrec_win -lws2_32
...
gcc -c "%NET%_ERC.c" -o "%NET%_ERC.obj"
g++ -o "%NET%_derive_RES.exe" "%NET%_ERC.obj" "%BIN_DIR%\libderive_RES_win.a" -L"%SHARED_BIN_DIR%" -lsysdep_win -lws2_32
